...
<body class="antialiased bg-white font-sans text-gray-900">
    ...
    <main class="w-full">
        ...
        <!-- start hero Remaja Masjid -->
        <div class="bg-gray-100" id="heroHeader">
            <section
                class="relative bg-green-700 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 overflow-hidden py-48 flex items-center min-h-screen">
                ...
                <div class="relative z-10 flex flex-col lg:flex-row items-center w-full">
                    ...
                    <div class="lg:w-1/2" data-aos="fade-right" data-aos-delay="200">
                        ...
                        <p class="text-green-100 text-xl md:text-2xl leading-snug mt-4">
                            Remaja Masjid Al-Ikhlas merupakan wadah kreatif dan spiritual bagi generasi muda Islam untuk tumbuh bersama dalam iman dan kontribusi sosial.
                        </p>
                        <p class="text-green-100 text-xl md:text-2xl leading-snug mt-4">
                            Melalui berbagai kegiatan seperti kajian, bakti sosial, pelatihan kepemimpinan, dan event islami, kami membentuk karakter remaja yang aktif, cerdas, dan berakhlak mulia.
                        </p>
                        <p class="text-green-100 text-xl md:text-2xl leading-snug mt-4">
                            Mari bergabung bersama kami dalam gerakan positif untuk membangun masa depan yang lebih baik.
                        </p>
                    ...
                    <div class="lg:w-1/2 mt-8 lg:mt-0 lg:pl-12" data-aos="fade-left" data-aos-delay="800">
                        <div id="hero-slider" class="relative overflow-hidden rounded-lg shadow-lg cursor-pointer"
                            ...
                            <div id="slider-inner" class="flex transition-transform duration-500 ease-in-out">
                                <img src="images/remaja-slider-1.jpg" alt="Kegiatan Remaja Masjid"
                                    class="w-full flex-shrink-0 object-cover transform transition duration-500 hover:scale-105">
                                <img src="images/remaja-slider-2.jpg" alt="Pengajian Remaja"
                                    class="w-full flex-shrink-0 object-cover transform transition duration-500 hover:scale-105">
                                <img src="images/remaja-slider-3.jpg" alt="Aksi Sosial Remaja"
                                    class="w-full flex-shrink-0 object-cover transform transition duration-500 hover:scale-105">
                            </div>
                        </div>
                    </div>
        ...
        <section id="gallery" class="relative bg-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-24">
            ...
            <div class="mb-12" data-aos="fade-up">
                <h2 class="text-3xl md:text-4xl font-bold leading-tight text-gray-900 text-center">
                    Galeri Kegiatan Kelompok Remaja Masjid
                </h2>
                <p class="text-gray-600 mt-4 max-w-2xl mx-auto text-center">
                    Lihat momen-momen berharga dan kebersamaan yang terjadi di dalam kegiatan kelompok Ikatan Remaja
                    Masjid. Klik pada gambar untuk melihat detail secara lebih besar.
                </p>
            </div>
            ...
            <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="relative group">
                    <img src="https://source.unsplash.com/600x400/?youth,mosque" alt="Kegiatan Remaja Masjid"
                ...
                <!-- Gallery Item 2 -->
                <div class="relative group">
                    <img src="https://source.unsplash.com/600x400/?youth,discussion" alt="Diskusi Remaja"
                        class="w-full h-64 object-cover rounded-lg cursor-pointer transition-transform duration-300 hover:scale-105"
                        onclick="openGalleryModal(this.src)">
                </div>
                <!-- Gallery Item 3 -->
                <div class="relative group">
                    <img src="https://source.unsplash.com/600x400/?youth,event" alt="Kegiatan Sosial Remaja"
                        class="w-full h-64 object-cover rounded-lg cursor-pointer transition-transform duration-300 hover:scale-105"
                        onclick="openGalleryModal(this.src)">
                </div>
                <!-- Gallery Item 4 -->
                <div class="relative group">
                    <img src="https://source.unsplash.com/600x400/?reunion,youth" alt="Pertemuan Remaja"
                        class="w-full h-64 object-cover rounded-lg cursor-pointer transition-transform duration-300 hover:scale-105"
                        onclick="openGalleryModal(this.src)">
                </div>
                <!-- Gallery Item 5 -->
                <div class="relative group">
                    <img src="https://source.unsplash.com/600x400/?youth,study" alt="Kajian Remaja"
                        class="w-full h-64 object-cover rounded-lg cursor-pointer transition-transform duration-300 hover:scale-105"
                        onclick="openGalleryModal(this.src)">
                </div>
                <!-- Gallery Item 6 -->
                <div class="relative group">
                    <img src="https://source.unsplash.com/600x400/?youth,night" alt="Suasana Malam Remaja"
                        class="w-full h-64 object-cover rounded-lg cursor-pointer transition-transform duration-300 hover:scale-105"
                        onclick="openGalleryModal(this.src)">
                </div>
            </div>
